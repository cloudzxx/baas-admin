...
from hyperledger_fabric.settings import FXBAAS_HOME, CRYPTO_CONFIG, FABRIC_TOOL
...
def create_channel(channel_name: str):
    ...
    with open(os.path.join(FXBAAS_HOME, "config", "configtx.yaml"), "r", encoding="utf-8") as f:
    ...
    channel_directory = os.path.join(FXBAAS_HOME, channel_name)
