    ...
    case 'orgAdmin-token':
      return res.json({
        ...
        user: {
          ...
          username: 'orgAdmin',
          role: 'administrator',
          email: 'administrator@baas-admin.com',
          organization: null,
        },
      });
    default:
...
export default {
  ...
  'POST /api/v1/login': (req, res) => {
    ...
    if (password === 'pass' && email === 'admin@baas-admin.com') {
      res.send({
        token: 'admin-token',
        user: {
          id: 'administrator',
          ...
          organization: {
            ...
            name: 'org1.baas-admin.com',
          },
        },
      });
      return;
    }
    if (password === 'password' && email === 'member@baas-admin.com') {
      res.send({
        token: 'user-token',
        user: {
          id: 'user',
          role: 'member',
          email: 'member@baas-admin.com',
          organization: {
            id: 'a760606b-f55d-40bb-8e06-4c9da5ad49a6',
            name: 'org1.baas-admin.com',
          },
